      ...
      <div className={`flex justify-between w-11/12 mx-auto transition-all duration-300 max-[425px]:ml-0 ${isScrolled ? 'h-20' : 'h-28'}`}>
        ...
        <div id="menu" className="flex justify-start my-auto max-[1022px]:hidden">
          <ul className={`menu text-2xl menu-vertical lg:menu-horizontal bg-base-200 mx-2 gap-5 rounded-box transition-all duration-300 ${isScrolled ? 'text-xl' : 'text-2xl'}`}>
            <Link to="/"><li className="after:scale-x-100 after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-full after:origin-left after:bg-[#f59542] after:duration-500 after:transition-transform hover:text-[#f59542] duration-300 transition-colors mx-2 cursor-pointer text-[#f59542]">Home</li></Link>
            <Link to="/AboutUs"><li className="hover:after:scale-x-100 after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-full after:origin-left after:scale-x-0 after:bg-[#f59542] after:duration-500 after:transition-transform hover:text-[#f59542] text-black duration-300 transition-colors mx-2 cursor-pointer">About Us</li></Link>
            ...
            <Link to="/Products">
              <div
                ...
                className="hover:after:scale-x-100 after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-full after:origin-left after:scale-x-0 after:bg-[#f59542] after:duration-500 after:transition-transform group-hover:text-[#f59542] text-black duration-300 transition-colors mx-2 cursor-pointer"
              >
                Products
              </div>
              </Link>
            ...
            <Link to="/Contact"><li className="hover:after:scale-x-100 after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-full after:origin-left after:scale-x-0 after:bg-[#f59542] after:duration-500 after:transition-transform hover:text-[#f59542] text-black duration-300 transition-colors mx-2 cursor-pointer">Contact</li></Link> 
          </ul>
